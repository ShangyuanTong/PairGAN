# Modified from https://raw.githubusercontent.com/AlexiaJM/Relativistic-f-divergences/master/setting_up_script.sh

## Requirements
# preprocess_cat_dataset.py requires opencv-python
# precalc_stats.py requires Tensorflow
...
mkdir cats_bigger_than_256x256
...
## Move to your favorite place (remember to modify)
mv cats_bigger_than_32x32 <folder path to 32x32 data>
mv cats_bigger_than_64x64 <folder path to 64x64 data>
mv cats_bigger_than_128x128 <folder path to 128x128 data>
mv cats_bigger_than_256x256 <folder path to 256x256 data>

## Create FID stats (remember to modify)
python precalc_stats.py --data_path "folder path to 32x32 data" --output_path "output path for 32x32" -i "Inception model path"
python precalc_stats.py --data_path "folder path to 64x64 data" --output_path "output path for 64x64" -i "Inception model path"
python precalc_stats.py --data_path "folder path to 128x128 data" --output_path "output path for 128x128" -i "Inception model path"
python precalc_stats.py --data_path "folder path to 256x256 data" --output_path "output path for 256x256" -i "Inception model path"
